 ...
 * 
 * Last-Modified: Mon, 07 Nov 2011 08:13:22 GMT
 */
(function() {
  /*
  ...
  */
  var API, ContentEditable, DOMUtils, Detector, Event, HTMLTidy, Prerange, Selection, Surround, partial;
  ...
  ContentEditable = (function() {
    ...
    function ContentEditable(iframe) {
      ...
      this.bind('ready', __bind(function() {
        ...
        Event.bind(this.body, 'focus click dblclick keydown keypress keyup blur paste', __bind(function(e) {
          e.target = this;
          return this.fire(e);
        }, this));
        ...
        return this.bind('focus click dblclick keydown keyup paste blur', __bind(function() {
          return this.update();
        }, this));
      }, this));
    }
  ...
  this.Richarea = (function() {
    ...
    function Richarea(iframe) {
      ...
      this.raw.ready(__bind(function() {
        ...
        this.raw.bind('focus click dblclick keydown keypress keyup paste blur change', __bind(function(e) {
          e.target = this;
          return this.fire(e);
        }, this));
    ...
    Richarea.prototype.getPath = function() {
      var cursor, path, range, selection;
      selection = this.selection.getSelection();
      if (selection.rangeCount > 0) {
        range = selection.getRangeAt(0);
        cursor = range.commonAncestorContainer;
        path = [];
        while ((cursor != null) && cursor.toString() !== '[object HTMLBodyElement]') {
          if (!DOMUtils.isDataNode(cursor)) {
            path.push(cursor.tagName);
          }
          cursor = cursor.parentNode;
        }
        path = path.reverse();
