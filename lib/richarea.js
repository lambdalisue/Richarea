(function() {
  ...
  */
  var Browser, DOMMunipulator, RawController;
  ...
  this.Richarea = (function() {
    ...
    Richarea.prototype.heading = function(level) {
      if (this.isSurroundSupport() === 2) {
        ...
        return this.execCommandAndWait('formatblock', "<h" + level + ">");
      }
    };
    Richarea.prototype.bold = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('bold');
      }
    };
    ...
    Richarea.prototype.italic = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('italic');
      }
    };
    ...
    Richarea.prototype.underline = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('underline');
      }
    };
    Richarea.prototype.strikethrough = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('strikethrough');
      }
    };
    ...
    Richarea.prototype.subscript = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('subscript');
      }
    };
    Richarea.prototype.superscript = function() {
      if (this.isSurroundSupport() > 0) {
        ...
        return this.execCommandAndWait('superscript');
      }
    };
    Richarea.prototype.foreColor = function(color) {
      if (this.isSurroundSupport() === 2) {
        ...
        return this.execCommandAndWait('forecolor', color);
      }
    };
    Richarea.prototype.backColor = function(color) {
      ...
      return this.execCommandAndWait(command, color);
    };
    Richarea.prototype.fontName = function(name) {
      if (this.isSurroundSupport() === 2) {
        ...
        return this.execCommandAndWait('fontname', name);
      }
    };
    Richarea.prototype.fontSize = function(size) {
      if (this.isSurroundSupport() === 2) {
        ...
        return this.execCommandAndWait('fontsize', size);
      }
    };
    Richarea.prototype.indent = function() {
      return this.execCommandAndWait('indent');
    };
    Richarea.prototype.outdent = function() {
      return this.execCommandAndWait('outdent');
    };
    Richarea.prototype.insertLink = function(href) {
      return this.execCommandAndWait('createlink', href);
    };
    Richarea.prototype.insertImage = function(src) {
      return this.execCommandAndWait('insertimage', src);
    };
    Richarea.prototype.insertOrderedList = function() {
      return this.execCommandAndWait('insertorderedlist');
    };
    Richarea.prototype.insertUnorderedList = function() {
      return this.execCommandAndWait('insertunorderedlist');
    };
    Richarea.prototype.insertHorizontalRule = function() {
      return this.execCommandAndWait('inserthorizontalrule');
    };
    Richarea.prototype.copy = function() {
      return this.execCommandAndWait('copy');
    };
    Richarea.prototype.cut = function() {
      return this.execCommandAndWait('cut');
    };
    Richarea.prototype.paste = function() {
      return this.execCommandAndWait('paste');
    };
    Richarea.prototype["delete"] = function() {
      return this.execCommandAndWait('delete');
    };
    Richarea.prototype.undo = function() {
      return this.execCommandAndWait('undo');
    };
    Richarea.prototype.redo = function() {
      return this.execCommandAndWait('redo');
    };
    Richarea.prototype.justifyCenter = function() {
      return this.execCommandAndWait('justifycenter');
    };
    Richarea.prototype.justifyFull = function() {
      return this.execCommandAndWait('justifyfull');
    };
    Richarea.prototype.justifyLeft = function() {
      return this.execCommandAndWait('justifyleft');
    };
    Richarea.prototype.justifyRight = function() {
      return this.execCommandAndWait('justifyright');
    };
    Richarea.prototype.selectAll = function() {
      return this.execCommandAndWait('selectall');
    };
    Richarea.prototype.unselect = function() {
      return this.execCommandAndWait('unselect');
    };
    return Richarea;
  })();
}).call(this);
