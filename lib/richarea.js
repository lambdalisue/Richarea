 ...
 * 
 * Last-Modified: Mon, 28 Nov 2011 02:32:39 GMT
 */
(function() {
  /*
  ...
  */
  var ContentEditable, DOMUtils, Detector, Event, HTMLTidy, Prerange, Selection, Style, partial;
  ...
  */
  Style = {
    _getActualStyleValues: function(styles) {
      var key, results, tmp, value;
        ...
        if (!(this.iframe.addEventListener != null)) {
          this.iframe.attachEvent('onreadystatechange', __bind(function() {
            if (this.iframe.readyState === 'complete') {
              this.iframe.detachEvent('onreadystatechange', arguments.callee);
