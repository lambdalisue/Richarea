    ...
    Richarea.prototype.surround = function(html) {
      ...
      if (this.raw.window.getSelection != null) {
        surroundCallback = __bind(function(leaf) {
          var cursorNode, grandParentNode, nextSibling, parentNode, parentNodeTagName, wrapNode, wrapNodeTagName;
          ...
          while ((cursorNode.parentNode != null) && !(cursorNode.previousSibling != null) && !(cursorNode.nextSibling != null)) {
            ...
            if (parentNodeTagName.startsWith('h') && wrapNodeTagName.startsWith('h')) {
