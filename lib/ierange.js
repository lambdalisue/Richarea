(function() {
  ...
  */
  var DOMUtils, RangeIterator, TextRangeUtils, exports;
  ...
  TextRangeUtils = (function() {
    ...
    TextRangeUtils.convertToDOMRange = function(textRange, document) {
      var adaptBoundary, domRange, endOffset;
    ...
    TextRangeUtils.convertFromDOMRange = function(domRange) {
  ...
  RangeIterator = (function() {
    ...
    RangeIterator.prototype.getSubtreeIterator = function() {
      var subRange;
      subRange = new DOMRange(this.range._document);
  ...
  this.DOMRange = (function() {
    ...
    DOMRange.prototype._refreshProperties = function() {
      var node;
    ...
    DOMRange.prototype.setStart = function(container, offset) {
      this.startContainer = container;
      this.startOffset = offset;
      return this._refreshProperties();
    };
    DOMRange.prototype.setEnd = function(container, offset) {
      this.endContainer = container;
      this.endOffset = offset;
      return this._refreshProperties();
    };
    DOMRange.prototype.setStartBefore = function(refNode) {
      var container, offset;
      container = refNode.parentNode;
      offset = DOMUtils.findChildPosition(refNode);
      return this.setStart(container, offset);
    };
    DOMRange.prototype.setStartAfter = function(refNode) {
      var container, offset;
      container = refNode.parentNode;
      offset = DOMUtils.findChildPosition(refNode);
      return this.setStart(container, offset + 1);
    };
    DOMRange.prototype.setEndBefore = function(refNode) {
      var container, offset;
      container = refNode.parentNode;
      offset = DOMUtils.findChildPosition(refNode);
      return this.setEnd(container, offset);
    };
    DOMRange.prototype.setEndAfter = function(refNode) {
      var container, offset;
      container = refNode.parentNode;
      offset = DOMUtils.findChildPosition(refNode);
      return this.setEnd(container, offset + 1);
    };
    DOMRange.prototype.selectNode = function(refNode) {
      this.setStartBefore(refNode);
      return this.setEndAfter(refNode);
    };
    DOMRange.prototype.selectNodeContents = function(refNode) {
      this.setStart(refNode, 0);
      return this.setEnd(refNode, DOMUtils.getNodeLength(refNode));
    };
    DOMRange.prototype.collapse = function(toStart) {
      if (toStart) {
    ...
    DOMRange.prototype.insertNode = function(newNode) {
    ...
    DOMRange.prototype.surroundContents = function(newNode) {
      var content;
    ...
    DOMRange.prototype.compareBoundaryPoints = function(how, sourceRange) {
    ...
    DOMRange.prototype.cloneRange = function() {
      var range;
      range = new DOMRange(this.document);
    ...
    DOMRange.prototype.createContextualFragment = function(tagString) {
  ...
  this.DOMSelection = (function() {
    function DOMSelection(document) {
      ...
      this.isCollapsed = !(range != null) || range.collapsed ? true : false;
    }
    DOMSelection.prototype._selectionChangeHolder = function() {
      var textRange;
      textRange = this._document.selection.createRange();
      return this.rangeCount = this._selectionExists(textRange) ? 1 : 0;
    };
    DOMSelection.prototype._selectionExists = function(textRange) {
      var c1, c2;
      c1 = textRange.compareEndPoints('StartToEnd', textRange) !== 0;
      c2 = textRange.parentElement().isContentEditable;
      return c1 && c2;
    };
    DOMSelection.prototype.addRange = function(range) {
    ...
    DOMSelection.prototype.removeAllRanges = function() {
      return this._document.selection.empty();
    };
    DOMSelection.prototype.getRangeAt = function(index) {
      var textRange;
      textRange = this._document.selection.createRange();
    ...
    DOMSelection.prototype.toString = function() {
